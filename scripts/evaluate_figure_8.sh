...
mkdir -p results/m3ed/pretrained/bth_single

# Assuming that user already ran table 3 scripts
...
do
    ...
    do
        echo "Launching..."
        echo "CUDA_VISIBLE_DEVICES=$CUDA_DEVICE python src/inference.py --data_root $DATA_PATH  --checkpoint_path $WEIGHTS_PATH/baseline/$ER.pth --save_root tmp --dataset m3ed --num_events 500000 --crop_height 720 --crop_width 1296 --raw_mae_threshold 0.1 --m3ed_raw_offset_us $RAW_OFFSET --guide_method guided 1>> results/m3ed/pretrained/guided/${ER}_${RAW_OFFSET}.txt"
        CUDA_VISIBLE_DEVICES=$CUDA_DEVICE python src/inference.py --data_root $DATA_PATH  --checkpoint_path $WEIGHTS_PATH/baseline/$ER.pth --save_root tmp --dataset m3ed --num_events 500000 --crop_height 720 --crop_width 1296 --raw_mae_threshold 0.1 --m3ed_raw_offset_us $RAW_OFFSET --guide_method guided 1>> results/m3ed/pretrained/guided/${ER}_${RAW_OFFSET}.txt
        echo "Done."
    done
    ...
    do
        echo "Launching..."
        echo "CUDA_VISIBLE_DEVICES=$CUDA_DEVICE python src/inference.py --data_root $DATA_PATH  --checkpoint_path $WEIGHTS_PATH/baseline/$ER.pth --save_root tmp --dataset m3ed --num_events 500000 --crop_height 720 --crop_width 1296 --raw_mae_threshold 0.1 --m3ed_raw_offset_us $RAW_OFFSET --guide_method vsh --vsh_patch_size 3 --vsh_maskocc --vsh_uniform_patch --vsh_splatting --vsh_method rnd --vsh_blending 0.5 1>> results/m3ed/pretrained/vsh/${ER}_${RAW_OFFSET}.txt"
        CUDA_VISIBLE_DEVICES=$CUDA_DEVICE python src/inference.py --data_root $DATA_PATH  --checkpoint_path $WEIGHTS_PATH/baseline/$ER.pth --save_root tmp --dataset m3ed --num_events 500000 --crop_height 720 --crop_width 1296 --raw_mae_threshold 0.1 --m3ed_raw_offset_us $RAW_OFFSET --guide_method vsh --vsh_patch_size 3 --vsh_maskocc --vsh_uniform_patch --vsh_splatting --vsh_method rnd --vsh_blending 0.5 1>> results/m3ed/pretrained/vsh/${ER}_${RAW_OFFSET}.txt
        echo "Done."
    done
    ...
    do
        echo "Launching..."
        echo "CUDA_VISIBLE_DEVICES=$CUDA_DEVICE python src/inference.py --data_root $DATA_PATH  --checkpoint_path $WEIGHTS_PATH/baseline/$ER.pth --save_root tmp --dataset m3ed --num_events 500000 --crop_height 720 --crop_width 1296 --raw_mae_threshold 0.1 --m3ed_raw_offset_us $RAW_OFFSET --guide_method bth --bth_patch_size 3 --bth_maskocc --bth_method h-naive --bth_n_events 2 --bth_uniform_polarities --bth_splatting none 1>> results/m3ed/pretrained/bth_single/${ER}_${RAW_OFFSET}.txt"
        CUDA_VISIBLE_DEVICES=$CUDA_DEVICE python src/inference.py --data_root $DATA_PATH  --checkpoint_path $WEIGHTS_PATH/baseline/$ER.pth --save_root tmp --dataset m3ed --num_events 500000 --crop_height 720 --crop_width 1296 --raw_mae_threshold 0.1 --m3ed_raw_offset_us $RAW_OFFSET --guide_method bth --bth_patch_size 3 --bth_maskocc --bth_method h-naive --bth_n_events 2 --bth_uniform_polarities --bth_splatting none 1>> results/m3ed/pretrained/bth_single/${ER}_${RAW_OFFSET}.txt
        echo "Done."
    done
