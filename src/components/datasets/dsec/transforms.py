...
class ToTensor:
    ...
    def __call__(self, sample):
        ...
        if 'disparity_raw' in sample.keys():
            sample['disparity_raw'] = self.disparity_transform(sample['disparity_raw'])
...
class RandomCrop:
    ...
    def __call__(self, sample):
        ...
        if 'disparity_raw' in sample.keys():
            sample['disparity_raw'] = self.disparity_transform(sample['disparity_raw'], offset_x, offset_y)
